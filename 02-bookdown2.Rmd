...
The site and document class commands (and their settings) are the defaults in the bookdown template. They allow RStudio to recognize the directory as a book source directory and it will add the "Build Book" button in the "Build" pane [@xie_54_nodate].
...
*Italics* is created by placing a single asterisk around the intended sired word or phrase; **bold** is created with a double asterisk around the word or phrase to be bolded. This sentence is demonstrated, below.
